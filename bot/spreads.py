...
SPREADS: dict[str, Spread] = {
    ...
    "week": Spread(
        ...
        "Полный доступ: карта недели — ритм и мягкий фокус на 7 дней.",
        "general",
    ),
    "month": Spread(
        "month",
        ...
        "Полный доступ: развёрнутый месяц в светлом ключе.",
        "general",
    ),
    "compat": Spread(
        "compat",
        ...
        "Полный доступ: бережный взгляд на двоих (восходящий и карты).",
        "love",
    ),
    "deep": Spread(
        "deep",
        ...
        "Полный доступ / разово: глубокий живой разбор.",
        "general",
    ),
}
